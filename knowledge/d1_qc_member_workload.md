...
Dashboard นี้ คือ QC_MEMBER WORKLOAD BY LOT คือ Dashboard Panel ประเภท Horizontal Bar Chart ที่ถูกออกแบบมาเพื่อวัดภาระงานที่แท้จริงของ QC Member ที่นับเป็นจำนวน Lot นับเป็น lot
### วัตถุประสงค์
...
**มีขั้นตอนดังนี้**
- เปิด Dashboard D1 — QC Overview → เลือก QC_MEMBER WORKLOAD → แท็บ QC_MEMBER WORKLOAD BY LOT
...
### 1.1.1.7 Dashboard Structure

**Digital QC Project**

▼ 📂 **D1 — QC Overview /**
&nbsp;&nbsp;&nbsp;&nbsp;> 🖥️ **QC_MEMBER WORKLOAD /**
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-> 📊 **<span style="color: red;">QR_MEMBER WORKLOAD BY LOT</span>**
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-> 📊 QR_MEMBER WORKLOAD BY STATE TIMELINE
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-> 📊 QR_MEMBER WORKLOAD BY STATUS
&nbsp;&nbsp;&nbsp;&nbsp;> 🖥️ ROOM TEMP & HUMIDITY PER MONTHLY AVG /
...
Dashboard นี้ คือ QC_MEMBER WORKLOAD BY STATE TIMELINE คือ Panel ที่ตรวจสอบค่า State Timeline ของจำนวน Lot ที่ได้ถูกวัดงานที่ของแต่ละ QC Member ที่นับเป็นจำนวน Lot นับเป็น lot
### วัตถุประสงค์
...
**มีขั้นตอนดังนี้**
เปิด Dashboard D1 — QC Overview → เลือก QC_MEMBER WORKLOAD → แท็บ QC_MEMBER WORKLOAD BY STATE TIMELINE
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-> 📊 **<span style="color: red;">QR_MEMBER WORKLOAD BY STATE TIMELINE</span>**
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-> 📊 QR_MEMBER WORKLOAD BY STATUS
&nbsp;&nbsp;&nbsp;&nbsp;> 🖥️ ROOM TEMP & HUMIDITY PER MONTHLY AVG /
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-> 📊 ROOM TEMP & HUMIDITY PER MONTHLY AVG
▼ 📂 **D2 — Dimensional SPC /**
...
Dashboard นี้ คือ QC_MEMBER WORKLOAD BY STATUS คือ Panel ที่ตรวจสอบค่า Status ที่แบ่งเป็น ‘OK’ คือ ผ่านเกณฑ์ และ ‘NG’ คือ ไม่ผ่านเกณฑ์  ของจำนวน Lot ที่ได้ถูกวัดงานที่ของแต่ละ QC Member ที่นับเป็นจำนวน Lot
### วัตถุประสงค์
...
**ขั้นตอน:**
เปิด Dashboard D1 — QC Overview → เลือก QC_MEMBER WORKLOAD → แท็บ QC_MEMBER WORKLOAD BY STATUS
เลือก Filter ให้ตรงกับช่วงเวลาที่ต้องการ
Data Type = Injection
Year = ปีที่ต้องการ
Months = เดือนที่ต้องการ หรือเลือกทั้งหมด
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-> 📊 QR_MEMBER WORKLOAD BY LOT
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-> 📊 QR_MEMBER WORKLOAD BY STATE TIMELINE
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-> 📊 **<span style="color: red;">QR_MEMBER WORKLOAD BY STATUS</span>**
&nbsp;&nbsp;&nbsp;&nbsp;> 🖥️ ROOM TEMP & HUMIDITY PER MONTHLY AVG /
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-> 📊 ROOM TEMP & HUMIDITY PER MONTHLY AVG
▼ 📂 **D2 — Dimensional SPC /**
&nbsp;&nbsp;&nbsp;&nbsp;> 🖥️ JUDGEMENT BY ISC CODE /
